...
- Suppliers: [`Supplier`](../../app/Models/Supplier.php), [`SupplierController`](../../app/Http/Controllers/SupplierController.php), [`SupplierRequest`](../../app/Http/Requests/SupplierRequest.php), [`suppliers migration`](../../database/migrations/2026_08_29_211509_create_suppliers_table.php)
- Supplies: [`Supply`](../../app/Models/Supply.php), [`SupplyController`](../../app/Http/Controllers/SupplyController.php), [`SupplyRequest`](../../app/Http/Requests/SupplyRequest.php), [`supplies migration`](../../database/migrations/2026_08_29_211510_create_supplies_table.php)
- Payments: [`SupplierPayment`](../../app/Models/SupplierPayment.php), [`SupplierPaymentController`](../../app/Http/Controllers/SupplierPaymentController.php), [`SupplierPaymentRequest`](../../app/Http/Requests/SupplierPaymentRequest.php), [`RecordSupplierPayment`](../../app/Actions/RecordSupplierPayment.php), [`supplier payments migration`](../../database/migrations/2026_08_29_211511_create_supplier_payments_table.php), [`PaymentMethod`](../../app/Enums/PaymentMethod.php)
- Expense integration: [`Expense`](../../app/Models/Expense.php), [`CashDrawer`](../../app/Support/CashDrawer.php), [`expense link migration`](../../database/migrations/2026_08_30_041907_link_supplier_payments_to_expenses.php)
- Access/navigation: [`Permission`](../../app/Enums/Permission.php), [`AdminModule`](../../app/Modules/Features/AdminModule.php), [`permission migration`](../../database/migrations/2026_08_29_211520_add_manage_suppliers_permission.php)
